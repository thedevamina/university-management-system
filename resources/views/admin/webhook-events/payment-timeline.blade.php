    ...
    <div class="max-w-7xl mx-auto py-6">
        ...
        <div class="mt-6 bg-white rounded-lg shadow">
            ...
            <table class="w-full">
                ...
                <tr class="border-b">
                    <td class="p-3 font-semibold w-64">Payment ID</td>
                ...
                <tr class="border-b">
                    <td class="p-3 font-semibold">Stripe Session</td>
                    <td class="p-3">
                        {{ $payment->stripe_session_id ?? 'N/A' }}
                    </td>
                </tr>

                <tr>
                    <td class="p-3 font-semibold">Payment Intent</td>
                    <td class="p-3">
