<x-app-layout>
    ...
    <div class="py-6 max-w-lg mx-auto sm:px-6 lg:px-8">
        <form action="{{ route('admin.courses.store') }}" method="POST" class="bg-white p-6 shadow rounded space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="code" value="{{ old('code') }}" class="w-full border rounded p-2" placeholder="e.g. CS101">
            ...
            <div>
                <label class="block mb-1">Assign Faculty (optional)</label>
            ...
            <div>
                ...
                <input type="number" name="credit_hours" value="{{ old('credit_hours', 3) }}" min="1" max="6" class="w-full border rounded p-2">
