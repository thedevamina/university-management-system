<x-app-layout>
    <div class="max-w-4xl mx-auto py-8 px-4">
        ...
        <h2 class="text-2xl font-bold mb-2">
            Documents – {{ $student->user->name }}
        </h2>
        <p class="text-gray-500 mb-6">Roll No: {{ $student->roll_no }}</p>
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <form action="{{ route('admin.students.documents.store', $student) }}"
                  method="POST"
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="px-4 py-2">
                                <form action="{{ route('admin.students.documents.destroy', [$student, $doc]) }}"
                                      method="POST"
